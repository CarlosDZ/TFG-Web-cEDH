...
<style>
/*No-Scoped to reutilize styles on register form*/
#mainContainer-login {
    overflow: hidden;
    width: 100%;
    height: 100vh;
...
#loginFormBox {
    ...
    input {
        ...
        padding: 5px;
        height: 100%;
        background-color: var(--login-form-data-bg);
        border: solid 2px var(--login-form-data-border);
        border-radius: 20px;
...
@media (min-width: 850px) {
    #mainContainer-login {
        background-image:
            ...
            url("../assets/images/tymna_the_weaver.webp");
        background-size:
            cover,
            auto 100%;
        background-position:
    ...
    #loginFormBox {
        input {
            font-size: large;
            transition: transform ease 0.23s;
        }
        input:focus {
