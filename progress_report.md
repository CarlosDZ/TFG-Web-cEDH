...
## 11-12-2025
Buena noticia. Han cambiado la fecha de entrega del TFG al tercer trimestre (Mayo-Junio). Esto me dara tiempo a mejorar muchas cosas del backend como la seguridad de credenciales en la DB a demas de tener bastante tiempo para el frontend. Aun asi planteo tener Vistas clave como los formularios y Home listas para mediados de Enero, ya que quiero aprovechar las vacaciones para pedir a mi madre consejo sobre temas de diseño grafico. No me dara tiempo a hacer todas antes del 10 de Enero, pero teniendo paginas clave que usar de ejemplo sin duda podre aplicar las mismas tecnicas al resto del frontend.
Hoy no puedo ver nada de lo que programo pues estoy trabajando desde otro dispositivo. Quitando eso, he hecho la pagina de registro modificando la de login y aprendido a utilizar el v-model de Vue para no depender de getElementById. No era un problema tecnico pero gran parte de mi interes en usar Vue para el frontend es aprender nuevas tecnologias asi que guay. Tambien empezare a hacer mejor praxis con los issues, releases y proyectos de github ahora que cuento con mas tiempo, aunque a partir de mañana (Odio la multitarea de windows y la navegacion de Chrome asi que prefiero dedicar el dia a simplemente codear)

He hecho la gestion de sesion de usuario en frontend con pinia. Pensaba que la haria usando la cookie de sesion, pero investigando he visto que al ser el contenido de esta un token jwt que es basicamente un string firmado, me salia mucho mas a cuenta usarla simplemente para la autenticacion del backend (analizandola en middlewares) y gestionar el estado de la sesion en el frontend por medio de pinia para poder modificar paginas y funciones segun el estado y tener facil acceso a credenciales no sensibles necesarias para el front (como el nombre o la bio del user).